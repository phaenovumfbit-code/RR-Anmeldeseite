/*
  # Fix competition names and remove address fields

  1. Changes
    - Remove address fields from anmeldungen table
    - Update wettbewerbe table with correct competition names matching frontend
    - Ensure proper foreign key relationships for team competitions

  2. Tables affected
    - anmeldungen: Remove address-related columns
    - wettbewerbe: Update competition names to match frontend exactly
    - team_wettbewerbe: Maintains foreign key relationships

  3. Data integrity
    - Existing team-competition relationships are cleared and recreated
