/*
  # Ensure T-shirt size field exists in teilnehmer table

  1. Changes
    - Add `tshirt_groesse` column to `teilnehmer` table if it doesn't exist
...
-- Add T-shirt size column to teilnehmer table if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
