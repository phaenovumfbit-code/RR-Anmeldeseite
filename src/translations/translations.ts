...
export const translations: Record<'de' | 'en', Translation> = {
  de: {
    ...
    paymentConfirmation: 'Nach Eingang Ihrer Zahlung erhalten Sie umgehend eine schriftliche Anmeldebestätigung.Vielen Dank für Ihr Vertrauen und      viel Freude bei der Teilnahme am RoboRave!',
